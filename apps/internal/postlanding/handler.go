...
// Register mounts every /postlandings route onto r. The caller applies
...
func (h *Handler) list(w http.ResponseWriter, r *http.Request) {
	...
	postlandings, err := h.svc.List(r.Context(), orgID)
	if err != nil {
		apierror.Write(w, h.logger, err)
		return
	}
	writeJSON(w, http.StatusOK, map[string]any{"postlandings": postlandings})
}
