...
**Статус:** A1 и A2 ПРИМЕНЕНЫ в спеку 2026-08-13 (§45, §59, CLAUDE.md инвариант
#3). A3 — по-прежнему предложение, не применена.
**Дата:** 2026-08-13
...
| A3 | Weighted pick детерминирован по ключу визита, а не по ГСЧ | §38 + §39 + §58 | уточнение | ⬜ не применена | Реплики трекера расходятся в решениях; A/B-данные шумят |
